...
void setup()
{
  ...
  buttonZeroRoll = controlP5.addButton("ZERO").setValue(1).setPosition(535,200).setSize(40,16).setColorBackground(gray_);

  /****************************Buttons*********************************************************************/
   buttonWRITE =     controlP5.addButton("WRITE").setValue(1).setPosition(500,248).setSize(60,20).setColorBackground(gray_);
   buttonREAD =     controlP5.addButton("READ").setValue(1).setPosition(40,248).setSize(60,20).setColorBackground(gray_);

   buttonCONFon =     controlP5.addButton("CONFIGon").setValue(1).setPosition(400,10).setSize(60,60).setColorBackground(gray_);
   buttonCONFoff =     controlP5.addButton("CONFIGoff").setValue(1).setPosition(330,10).setSize(60,60).setColorBackground(gray_);

   buttonP0 =     controlP5.addButton("P0").setValue(1).setPosition(490, 5).setSize(20,20).setColorBackground(gray_);
   buttonP1 =     controlP5.addButton("P1").setValue(1).setPosition(490,30).setSize(20,20).setColorBackground(gray_);
   buttonP2 =     controlP5.addButton("P2").setValue(1).setPosition(490,55).setSize(20,20).setColorBackground(gray_);

   buttonRCOff  =     controlP5.addButton("RC_OFF").setValue(1).setPosition(450,122).setSize(65,20).setColorBackground(gray_);
   buttonRCOn   =     controlP5.addButton("RC_ON").setValue(1).setPosition(450,100).setSize(65,20).setColorBackground(gray_);

   buttonYawRC  =     controlP5.addButton("Yaw_RC_Pan").setValue(1).setPosition(520,100).setSize(75,20).setColorBackground(gray_);
   buttonYawAut =     controlP5.addButton("Yaw_Auto_Pan").setValue(1).setPosition(520,122).setSize(75,20).setColorBackground(gray_);
